...
c      print *, "bar", bar(0:imax)
c      print *, "yneutr", yneutr(0:imax)
c      print *, "yprot", yprot(0:imax)
c      print *, "yelect", yelect(0:imax)
c      print *, "ymuon", ymuon(0:imax)
c      print *, "mstn", mstn(0:imax)
c      print *, "mstp", mstp(0:imax)
c      stop  !
...
c      print *, "yneutr", yneutr(0:imax)
c      print *, "yelect", yelect(0:imax)
c      print *, "a_cell", a_cell(0:imax) 
c      print *, "a_ion", a_ion(0:imax)
c      print *, "z_ion", z_ion(0:imax) 
c      print *, "v_ion", v_ion(0:imax)  
c      stop  !
...
c      print *, "kfn", kfn(0:imax)
c      print *, "kfp", kfp(0:imax)
c      print *, "kfe", kfe(0:imax)
c      print *, "kfm", kfm(0:imax)
c      print *, "durcae", durca_ctrl_e(0:imax)
c      print *, "durcam", durca_ctrl_m(0:imax)
c      stop  !
      if (icore.eq.0) then
         iret=4
...
c      print *, "cvn", cvn(0:imax)
c      print *, "cvp", cvp(0:imax)
c      print *, "cve", cve(0:imax)
c      print *, "cvm", cvm(0:imax)      
...
c      print *, "tcn", tcn(0:imax)
c      print *, "tcp", tcp(0:imax)
c      stop  !     
...
c AWS: Compute weights and effective temperature            
     ...
     2           temp,olum,lum,rad,rrho,ephi,dvol,e2phi,tcn,tcp,
