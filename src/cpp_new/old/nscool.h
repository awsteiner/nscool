...
class nscool {
  ...
  private:
    ...
    static constexpr double year = 3.1557600e7;
    static const int isize=10000;
  ...
  public:
    ...
    */
    ...
    /** \brief Object for computing specific heat
    */
    specheat spec;

    /** \brief Object for computing conductivities
    */
    conduct cond;

    /** \brief Object for computing densities
    */
    density dens;
    ...
    */
    ...
    double eta_arg,mag_coeff,tb_acc0,eta_0;
    ...
    */                    
    ...
    /** \brief Desc
     */
    void get_degenerate_density(std::vector<double> rrho, 
          std::vector<double> pres, std::vector<double> rhod, int imax, int ienv);

    /** \brief Calculate all specific heats
     */
    void get_Tc(int imax, int icore, int idrip,
    ...
    /** \brief Desc
     */
    void get_fermi_momenta(int imax, int icore,
    ...
    /** \brief Specify crust composition
      ...
      This function's wrapper is called in <tt>precool.f</tt>.
    */
    void get_crust_chemistry(int debug, const std::string version, int imax, int icore,
    ...
    /** \brief Specify core composition
      ...
      This function's wrapper is called in <tt>precool.f</tt>.
    */
    void get_core_chemistry(const std::string version, int imax, int icore, 
  ...
  /** \brief Execute main cooling calculation
     */
  void cooling(int iret,std::vector<double> neebrem_logt, 
